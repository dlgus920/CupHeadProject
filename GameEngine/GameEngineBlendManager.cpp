...
GameEngineBlendManager::GameEngineBlendManager() // default constructer 디폴트 생성자
{

}

GameEngineBlendManager::~GameEngineBlendManager() // default destructer 디폴트 소멸자
{
...
GameEngineBlendManager::GameEngineBlendManager(GameEngineBlendManager&& _other) noexcept  // default RValue Copy constructer 디폴트 RValue 복사생성자
{
